...
const Map<String, Map<AppLang, String>> _strings = {
  ...
  'reportReviewTitle': {
    AppLang.ko: '이 리뷰를 신고할까요?',
    AppLang.en: 'Report this review?',
    AppLang.ja: 'このレビューを通報しますか？',
    AppLang.zh: '举报这条评论？',
  },
  'reportReasonHint': {
    AppLang.ko: '신고 사유를 선택해 주세요',
    AppLang.en: 'Choose a reason',
    AppLang.ja: '通報の理由を選んでください',
    AppLang.zh: '请选择举报原因',
  },
  'reasonSpam': {
    AppLang.ko: '스팸·광고',
    AppLang.en: 'Spam or ads',
    AppLang.ja: 'スパム・広告',
    AppLang.zh: '垃圾/广告',
  },
  'reasonAbuse': {
    AppLang.ko: '욕설·혐오',
    AppLang.en: 'Abuse or hate',
    AppLang.ja: '暴言・ヘイト',
    AppLang.zh: '辱骂/仇恨',
  },
  'reasonSexual': {
    AppLang.ko: '음란·선정성',
    AppLang.en: 'Sexual content',
    AppLang.ja: 'わいせつ',
    AppLang.zh: '色情内容',
  },
  'reasonIllegal': {
    AppLang.ko: '불법·유해',
    AppLang.en: 'Illegal or harmful',
    AppLang.ja: '違法・有害',
    AppLang.zh: '违法/有害',
  },
  'reasonFalseInfo': {
    AppLang.ko: '허위·사칭',
    AppLang.en: 'False or impersonation',
    AppLang.ja: '虚偽・なりすまし',
    AppLang.zh: '虚假/冒充',
  },
  'reasonOther': {
  ...
  'reportDone': {
    AppLang.ko: '신고를 접수했어요',
    AppLang.en: 'Report submitted',
    AppLang.ja: '通報を受け付けました',
    AppLang.zh: '举报已提交',
  },
  'blockConfirmTitle': {
    AppLang.ko: '이 사용자를 차단할까요?',
    AppLang.en: 'Block this user?',
    AppLang.ja: 'このユーザーをブロックしますか？',
    AppLang.zh: '拉黑该用户？',
  },
  'blockConfirmBody': {
    AppLang.ko: '차단하면 이 사용자의 리뷰가 더 이상 보이지 않아요.',
    AppLang.en: "You won't see this user's reviews anymore.",
    AppLang.ja: 'ブロックすると、このユーザーのレビューは表示されなくなります。',
    AppLang.zh: '拉黑后将不再看到该用户的评论。',
  },
  'blockDone': {
    AppLang.ko: '차단했어요',
    AppLang.en: 'User blocked',
    AppLang.ja: 'ブロックしました',
    AppLang.zh: '已拉黑',
  },
  'bannedWordWarn': {
    AppLang.ko: '부적절한 표현이 포함되어 있어요',
    AppLang.en: 'Your review contains inappropriate language',
    AppLang.ja: '不適切な表現が含まれています',
    AppLang.zh: '内容包含不当用语',
  },
  'cancelAction': {
    AppLang.ko: '취소',
